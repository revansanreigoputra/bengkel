...
Route::get('/profil-bengkel', function () {
    return view('profil-bengkel');
})->name('profil-bengkel')->middleware('auth');

Route::get('/manajemen-sparepart', function () {
...
Route::get('/laravel-examples/manajemen-pelanggan', [UserController::class, 'index'])->name('manajemen-pelanggan')->middleware('auth');
