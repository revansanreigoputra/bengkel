<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">BengkelKu</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4 h-auto     w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('profil-bengkel') ? 'active' : '' }}" href="{{ route('profil-bengkel') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>profilbengkel</title>
                    ...
                    <span class="nav-link-text ms-1">Profil Bengkel</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('manajemen-sparepart') ? 'active' : '' }}" href="{{ route('manajemen-sparepart') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>manajemensparepart</title>
                            <g id="table" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('manajemen-service') ? 'active' : '' }}" href="{{ route('manajemen-service') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>manajemenservice</title>
                            <g id="table" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                    ...
                    <span class="nav-link-text ms-1">Manajemen Service</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('manajemen-teknisi') ? 'active' : '' }}" href="{{ route('manajemen-teknisi') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>manajementeknisi</title>
                            <g id="table" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="view-grid" transform="translate(12.000000, 12.000000)" fill="#FFFFFF"
                                    fill-rule="nonzero">
                                    <path class="color-foreground"
                    ...
                    <span class="nav-link-text ms-1">Manajemen Teknisi</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('manajemen-pelanggan') ? 'active' : '' }}"
                    href="{{ route('manajemen-pelanggan') }}">
                    <span class="nav-link-text ms-1">Manajemen Pelanggan</span>
                </a>
            </li>
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
