                ...
                <div class="col-12">
                    <div class="card">
                        <div class="pb-0 card-header">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="">Manajemen Pelanggan</h5>
...
<script src="/assets/js/plugins/dataprofil-bengkel.js"></script>
<script>
    const dataTableBasic = new simpleDataprofil-bengkel.DataTable("#datatable-search", {
        searchable: true,
        fixedHeight: true,
        columns: [{
            select: [2, 6],
